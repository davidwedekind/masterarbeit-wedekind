...
WITH FST AS (
	SELECT T.*
		...
		CASE
			WHEN (T.MATSIM_CAL_MAIN_MODE = 'car') THEN 'MIV'::text
			WHEN (T.MATSIM_CAL_MAIN_MODE = 'ride') THEN 'MIV'::text
			ELSE 'Umweltverbund'::text
		END AS VERBUND
...
REL_FOCUS_AREAS AS(
	...
	AND (START_GEM_AGS IN ('08115003', '08115045', '08116078', '08116077')
		AND END_GEM_AGS IN ('08115003', '08115045', '08116078', '08116077'))
),
