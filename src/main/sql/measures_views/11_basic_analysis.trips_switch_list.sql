...
SELECT M.RUN_NAME,
	...
	BC.REL_BOEBL_ESSL,
	BC.REL_FOCUS_AREAS,
	BC.RES_REL_BOEBL_ESSL,
	BC.RES_REL_FOCUS_AREAS,
	BC.MATSIM_CAL_MAIN_MODE FROM_BC_MODE,
	M.MATSIM_CAL_MAIN_MODE TO_M_MODE
FROM MATSIM_OUTPUT.SIM_TRIPS_ENRICHED BC
FULL JOIN MATSIM_OUTPUT.SIM_TRIPS_ENRICHED M ON BC.TRIP_ID = M.TRIP_ID
