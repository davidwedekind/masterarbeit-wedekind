-- basic_analysis.trips_by_mode_dgroup_rel
...
M_GROUPS AS (
	...
	ORDER BY RUN_NAME, REL_GROUP, MATSIM_CAL_MAIN_MODE
),


-- Create headers first to have the full combination of run_name, REL_GROUP, dgroup, mode
...
ORDER BY H.RUN_NAME, H.REL_GROUP, H.DISTANCE_GROUP_NO, H.MATSIM_CAL_MAIN_MODE