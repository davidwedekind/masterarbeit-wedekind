...
REG_STUTTGART_COMPLETE AS(
	SELECT P.RUN_NAME,
		...
		SUM(P."fareAmount") TOTAL_FARE_AMTS_PAID,
...
SELECT G1.RUN_NAME,
	G1.RES_GROUP,
	G1.AVG_NO_ZONES_TRAV,
	G1.AVG_FARE_AMT_PAID*(-1) AVG_FARE_AMT_PAID,
	G1.TOTAL_FARE_AMTS_PAID*(-1)*{**sfactor**} TOTAL_FARE_AMTS_PAID,
	(G1.TOTAL_FARE_AMTS_PAID-G2.TOTAL_FARE_AMTS_PAID)/G1.TOTAL_FARE_AMTS_PAID TOTAL_FARE_AMTS_CHANGE,
	G1.AVG_FARE_AMT_PER_ZONE_PAID*(-1) AVG_FARE_AMT_PER_ZONE_PAID,
	G1.AVG_TOTAL_PT_KM_DIST,
	G1.AVG_EUR_PER_PT_KM*(-1) AVG_EUR_PER_PT_KM,
	G1.AVG_TOTAL_PT_H_DUR,
	G1.AVG_EUR_PER_PT_H*(-1) AVG_EUR_PER_PT_H
FROM M_GROUPS G1
LEFT JOIN M_GROUPS G2
ON G1.RES_GROUP = G2.RES_GROUP
