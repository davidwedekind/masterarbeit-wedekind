WITH trip_stats_bc AS (
	...
	GROUP BY sim_trips_enriched_bc.run_name, sim_trips_enriched_bc.matsim_cal_main_mode
), 
trip_stats_measures AS (
	...
	WHERE (start_kreis_ags='08115' AND end_kreis_ags='08116') OR (start_kreis_ags='08116' AND end_kreis_ags='08115')
    GROUP BY sim_trips_enriched_measures.run_name, sim_trips_enriched_measures.matsim_cal_main_mode
)
