...
public class CreateBBSSupershuttle {
    private static final Logger log = Logger.getLogger(CreateBBSSupershuttle.class);

    public static void main(String[] args) {

        CreateBBSSupershuttle.Input input = new CreateBBSSupershuttle.Input();
